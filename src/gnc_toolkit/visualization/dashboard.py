...
def create_dashboard_app(figures, title="GNC Toolkit Mission Dashboard"):
    ...
    app.layout = html.Div([
        html.Header([
            ...
            html.P("Guidance, Navigation & Control Toolkit", style={'margin': '5px 0 0 0', 'opacity': '0.8'})
        ], style={
    ...
    ], style={'fontFamily': 'Arial, sans-serif', 'margin': '0', 'backgroundColor': '#ecf0f1', 'minHeight': '100vh'})
