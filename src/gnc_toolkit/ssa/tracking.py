...
def compute_mahalanobis_distance(x1: np.ndarray, x2: np.ndarray, cov1: np.ndarray, cov2: np.ndarray) -> float:
    """
...
def correlate_tracks(x1: np.ndarray, x2: np.ndarray, cov1: np.ndarray, cov2: np.ndarray, threshold: float = 3.0) -> bool:
    """
