...
def virtual_structure_control(state_actual: np.ndarray, state_desired: np.ndarray, gains: np.ndarray) -> np.ndarray:
    """
...
def leader_follower_control(leader_state: np.ndarray, follower_state: np.ndarray, desired_relative_state: np.ndarray, gains: np.ndarray) -> np.ndarray:
    """
...
def fuel_balanced_formation_keeping(states: np.ndarray, fuel_levels: np.ndarray, weights: np.ndarray) -> np.ndarray:
    """
...
def distributed_consensus_control(states: np.ndarray, laplacian_matrix: np.ndarray, gains: np.ndarray) -> np.ndarray:
    """
